        ...
        {signupProgress == 1 ? (
          <>
            ...
            <FormInputBtnWrapper type="submit" onClick={() => handleNext(2)}>
              <Button font='medium' typeDisabled='secondary'>Next</Button>
            </FormInputBtnWrapper>
          </>
        ) : signupProgress == 2 ? (
          <>
            ...
            <FormInputButtonsWrapper>
              <FormInputBtnWrapper
                onClick={() => setSignupProgress(1)}>
                <Button font='medium' typeDisabled='secondary'>Back</Button>
              </FormInputBtnWrapper>
          ...
          <>
            ...
            <FormInputButtonsWrapper>
              <FormInputBtnWrapper
                onClick={() => setSignupProgress(2)}>
                <Button font='medium' typeDisabled='secondary'>Back</Button>
              </FormInputBtnWrapper>
              <FormInputBtnWrapper type="submit" onClick={() => signUpHandler()}>
